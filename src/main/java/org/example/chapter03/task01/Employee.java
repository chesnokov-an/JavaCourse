...
/*
*
* Полиморфизм в Java — это принцип объектно-ориентированного программирования (ООП),
* который позволяет программе использовать объекты разных типов через единый интерфейс.
* Это способность одного и того же метода или объекта вести себя по-разному в зависимости от того,
* с каким типом данных он работает в данный момент.
*
* */